...
class Sda:
    ...
    def __init__( self, n_layers, num_epoch, en_act_func, dec_act_func, loss_func, optimizer, num_classes, n_hid, dropout, batch_size, mode, hostname):#,sftp
    ...
    def get_sda_dnn(self, x_train, y_train, x_test, data, protocol):
        ...
        if self.mode == 'Retraining':
            ...
            if self.hostname ==  config['server1']['hostname']:
                ...
                sftp = ssh.open_sftp()
                #self.sftp.chdir('/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/models')
                self.sftp.chdir(os.path.join(os.getcwd(),'models'))
                #self.sftp.get('{}_feature_extractor.h5'.format(protocol),'/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/models/{}_feature_extractor.h5'.format(protocol) )  
                self.sftp.get('{}_feature_extractor.h5'.format(protocol),os.path.join(os.getcwd(),'../models//{}_feature_extractor.h5'.format(protocol)))
                #sdae_model = tf.keras.models.load_model('/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/models/' + protocol + "_feature_extractor.h5")
                sdae_model = tf.keras.models.load_model(os.path.join(os.getcwd(),'../models/' + protocol + "_feature_extractor.h5"))
            else:
                #sdae_model = tf.keras.models.load_model('/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/models/' + protocol + "_feature_extractor.h5")
                sdae_model = tf.keras.models.load_model(os.path.join(os.getcwd(),'../models/' + protocol + "_feature_extractor.h5"))
        ...
        #sdae_model.save('/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/models/' + protocol + "_feature_extractor.h5")
        sdae_model.save(os.path.join(os.getcwd(),'../models/' + protocol + "_feature_extractor.h5"))
        if self.hostname == config['server1']['hostname']:
                ssh = paramiko.SSHClient()
                ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
                ...
                #sftp.get('{}_feature_extractor.h5'.format(protocol),'/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/models/{}_feature_extractor.h5'.format(protocol)) 
                sftp.get('{}_feature_extractor.h5'.format(protocol),os.path.join(os.getcwd(),'../models/{}_feature_extractor.h5'.format(protocol))) 
    ...
    def get_trained_classifier( self, model, x_train, y_train, data, protocol, training):
            ...
            if(training == 'trainFromScratch'):
                ...
                if self.hostname ==  config['server1']['hostname']:
                    ...
                    sftp.get('{}_SDAE_model.h5'.format(protocol),os.path.join(os.getcwd(),'../models/{}_SDAE_model.h5'.format(protocol)))    
                    ...
                    sdae_model = load_model(os.path.join(os.getcwd(),"models/" + protocol + "_" + "SDAE" + "_model.h5"))
                else:
                    #sdae_model = load_model("/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/models/" + protocol + "_" + "SDAE" + "_model.h5")
                    sdae_model = load_model(os.path.join(os.getcwd(),"../models/" + protocol + "_" + "SDAE" + "_model.h5"))
            ...
            plt.savefig(os.path.join(os.getcwd(),'../reports/' + protocol + '_loss_history'))
            #plt.savefig('/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/reports/' + protocol + '_loss_history')
            plt.show()
            ...
            plt.xlabel('Epoch')
            plt.legend(['Train', 'Test'], loc='upper left')
            #plt.savefig('/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/reports/' + protocol + '_accuracy_history')
            plt.savefig(os.path.join(os.getcwd(),'../reports/' + protocol + '_accuracy_history'))
            plt.show()
            return sdae_model
    ...
    def get_DNN( self, x_train, y_train, data, protocol):
        ...
        plt.xlabel('epoch')
        plt.legend(['train', 'test'], loc='upper left')
        #plt.savefig('home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/reports/' + protocol + '_DNN_loss_history')
        plt.savefig(os.path.join(os.getcwd(),'../reports/' + protocol + '_DNN_loss_history'))
        plt.show()
        ...
        plt.xlabel('Epoch')
        plt.legend(['Train', 'Test'], loc='upper left')
        plt.savefig(os.path.join(os.getcwd(),'../reports/' + protocol + '_DNN_accuracy_history'))
        #plt.savefig('/home/smarthome/SPEAR/varlab_dev/SPEAR/development/BDAC/Self_learning_retrain/reports/' + protocol + '_DNN_accuracy_history')
        plt.show()
